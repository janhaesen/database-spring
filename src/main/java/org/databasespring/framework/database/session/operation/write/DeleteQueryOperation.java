...
public class DeleteQueryOperation extends AbstractQueryOperation<DeleteQueryOperation, Integer> {

    private final String statement;
    private final Object parameter;

    public DeleteQueryOperation(String statement, Object parameter, DatabaseConnection databaseConnection) {
    ...
    public Integer execute(SqlSession sqlSession) throws DatabaseException {
        ...
        try {
            if (parameter != null) {
                affectedRecords = sqlSession.delete(statement, parameter);
            } else {
                affectedRecords = sqlSession.delete(statement);
            }
        } catch (Exception e) {
